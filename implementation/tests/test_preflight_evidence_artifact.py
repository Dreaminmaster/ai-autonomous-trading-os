...
def test_atos_manifest_non_dict(): _fail("atos-tests", {"evidence_manifest.json": "[]", "pytest.log": "x", "no_secret_scan.log": "x", "freqtrade_data/backtest_results/walk_forward_report.json": "x"}, expected_reason="not dict")
def test_atos_wrong_run_id(): m = _manifest(); m["run_id"] = "wrong"; _fail("atos-tests", {"evidence_manifest.json": m, "pytest.log": "x", "no_secret_scan.log": "x", "freqtrade_data/backtest_results/walk_forward_report.json": "x"}, expected_reason="manifest run")
