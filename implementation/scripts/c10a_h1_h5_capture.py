"""One-shot official-public OKX capture for frozen C10A H1-H5."""
...
def main() -> int:
    ...
    plan = capture_plan()
    package = C10ACapturePackage(args.output)
...
def cli() -> int:
    try:
        return main()
    except (C7AHistoricalCaptureError, C10AHistoricalCaptureError) as exc:
        print(
            json.dumps(
                {
                    "status": "FAIL",
