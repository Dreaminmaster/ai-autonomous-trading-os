"""One-shot official-public OKX capture for frozen C13A H1-H5."""
...
def main() -> int:
    ...
    plan = capture_plan()
    package = C13ACapturePackage(args.output)
...
def cli() -> int:
    try:
        return main()
    except (C7AHistoricalCaptureError, C13AHistoricalCaptureError) as exc:
        print(
            json.dumps(
                {
                    "status": "FAIL",
