...
class AutonomousRuntime:
    ...
    def run_once(self, symbol: str, candles: list[Candle], mark_price: float = 100.0) -> dict:
        ...
        # ── AI Decision (returns ProviderResult) ────────────────
        ...
        intent = provider_result.intent  # Extract TradeIntent from ProviderResult
        ...
        # ── Ledger — record all stages ──────────────────────────
        self.ledger.record("strategy_candidates", {"items": candidates})
        self.ledger.record("provider_result", provider_result.to_dict())
